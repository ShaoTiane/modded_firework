...
(function initFireworksAppConfig(global) {
	const config = {
		...
		storageVersion: "1.0",
		defaultWords: Object.freeze([ "万事如意", "平安喜乐","鹏程万里" ]),
		...
		selectors: Object.freeze({
			...
			wordTextInput: ".word-text-input",
			wordTextLabel: ".word-text-label",
			...
			backgroundFileInput: ".background-file-input",
backgroundFileBtn: ".background-file-btn",
backgroundFileName: ".background-file-name",
		...
		helpContent: Object.freeze({
			...
			wordText: {
    header: "自定义文字内容",
    body: "输入你想要的文字，多个文字用英文逗号分隔。留空则随机使用默认文字。",
},
			autoLaunch: {
				header: "自动放烟花",
